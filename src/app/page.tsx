    ...
    <div className="dynamic-width overflow-x-hidden">
      ...
      <section className="desktop-content-appearance home-additional-info mt-[80px] flex flex-col gap-[24px]">
        ...
        <p className="text-tertiaryProject text-[24px]">
          Explore <Link href="/services" className="text-quaternaryProject hover:underline">services</Link>, including website design, application development, and custom software solutions.
        </p>
